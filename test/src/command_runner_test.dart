...
import 'package:dartexify_cli/src/command_runner.dart';
...
void main() {
  group('DartexifyCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ProcessResult processResult;
    late DartexifyCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = DartexifyCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = DartexifyCliCommandRunner();
